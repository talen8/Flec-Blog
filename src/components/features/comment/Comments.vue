...
import { useComments } from '@/composables/useStores'
import { flattenComments, provideCommentContext } from '@/composables/useComment'
...
// 使用评论 store
const { comments, fetchComments, addComment, resetComments } = useComments()
