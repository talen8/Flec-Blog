...
import { useArticles, useCategories, useTags, useMenus } from '@/composables/useStores'
...
const { navigationMenus, aggregateMenus, fetchMenus } = useMenus()
const { total: articleCount, fetchArticles } = useArticles()
const { total: categoryCount, fetchCategories } = useCategories()
const { total: tagCount, fetchTags } = useTags()
...
const topAggregateMenus = computed(() => 
  aggregateMenus.value.filter(menu => !menu.parent_id)
)
      ...
      <div v-if="modelValue" class="drawer-overlay" @click="close">
        <div class="drawer-container" @click.stop>
          ...
          <div class="site-data">
            ...
            <a href="/tag" @click="close">
              <div class="headline">标签</div>
              <div class="length-num">{{ tagCount }}</div>
            </a>
            <a href="/category" @click="close">
                  ...
                  >
                    ...
                    <div class="aggregate-grid">
                      <a 
                        ...
                        @click="close"
                      >
                        <img v-if="child.icon && isIconUrl(child.icon)" :src="child.icon" :alt="child.title">
